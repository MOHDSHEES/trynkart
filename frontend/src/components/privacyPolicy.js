...
const Privacypolicy = () => {
  return (
    <div class="main">
      <Categorybanner name="Privacy Policy" />
      <div class="container mt-2">
        <p>
          ...
          “Platform”).
          <br />
          <br /> While you may be able to browse certain sections of the
          Platform without registering with us, however, please note we do not
          offer any product or service under this Platform outside India. Your
          personal information will primarily be stored and processed in India
          ...
          Platform, providing your information or availing out product/service,
        ...
        <p>
          ...
          from tracking of personalized advertising using the “Opt out of Ads
          Personalization” settings using your device’s settings application.
          TryNkart will have no access to your GAID once you select this
          feature.
        </p>
        <br />
        <br />
